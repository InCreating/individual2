...
<body>
<div class="container">
    <h2>Accounts of current user</h2>
    ...
    <div>
        <table border="1" >
            ...
            <c:forEach var="account" items="${accounts}">
                <tr onclick="location.href='/accountsByUser?userId=${account.user.userId}'" style="cursor: pointer;">
        ...
        <c:set var="totalBalance" value="0.0" />
        <c:forEach var="account" items="${accounts}">
            <c:set var="totalBalance" value="${totalBalance + account.balance}" />
        </c:forEach>
        <p>Total balance of all accounts: ${totalBalance} $</p>
        <p></p>
    </div>
</div>
</body>
