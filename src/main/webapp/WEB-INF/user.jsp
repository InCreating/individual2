...
<table border="1">
    ...
    <c:forEach var="user" items="${users}">
        <tr>
            ...
            <td>${user.name}</td>
            <td>${user.surname}</td>
            <td><a href="<c:url value='/deleteUser'><c:param name='userId' value='${user.userId}'/></c:url>"><svg xmlns="http://www.w3.org/2000/svg"  fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
